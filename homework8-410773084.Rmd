...
str_detect(ntpc_building_info$name,"停車場") -> pick_parking

ntpc_building_parking <- data.frame(
  type = ntpc_building_info$type[pick_parking],
  floer = ntpc_building_info$floer[pick_parking], name = ntpc_building_info$name[pick_parking],
  name_en = ntpc_building_info$name_en[pick_parking]
)
...
search_engine <- function(key_word)  {
   if(any(str_detect(ntpc_building_info$type,key_word) == T) | any(str_detect(ntpc_building_info$floer,key_word) == T) | any(str_detect(ntpc_building_info$name,key_word) == T) | any(str_detect(ntpc_building_info$name,key_word) == T) | any(str_detect(ntpc_building_info$name_en,key_word) == T)){
  ntpc_building_parking
} else {
  no_found(key_word)
}
...
```{r ans31}
a <- 
seatingChart <- list( row1 = c( "7" = 0L,"5" = 0L,"A1" = -1L,"3"= 0L,"1"=0L,"2"=0L,"4"=0L,"A2"= -1L,"6"=0L) , row2 = c( "7" = 0L,"5" = 0L,"A1" = -1L,"3"= 0L,"1"=0L,"2"=0L,"4"=0L,"A2"= -1L,"6"=0L) , row3 = c( "7" = 0L,"5" = 0L,"A1" = -1L,"3"= 0L,"1"=0L,"2"=0L,"4"=0L,"A2"= -1L,"6"=0L) , row4 = c( "7" = 0L,"5" = 0L,"A1" = -1L,"3"= 0L,"1"=0L,"2"=0L,"4"=0L,"A2"= -1L,"6"=0L), row5 = c( "7" = 0L,"5" = 0L,"A1" = -1L,"3"= 0L,"1"=0L,"2"=0L,"4"=0L,"A2"= -1L,"6"=0L) ,row6 =c( "7" = 0L,"5" = 0L,"A1" = -1L,"3"= 0L,"1"=0L,"2"=0L,"4"=0L,"A2"= -1L,"6"=0L) ,row7 = c( "7" = 0L,"5" = 0L,"A1" = -1L,"3"= 0L,"1"=0L,"2"=0L,"4"=0L,"A2"= -1L,"6"=0L) )
...
c(paste0("row1","-" , names(seatingChart$row1 [row1 == 0])), 
  paste0("row2","-" , names(seatingChart$row2[seatingChart$row2 == 0])),
  paste0("row3","-" , names(seatingChart$row3[seatingChart$row3 == 0])),
  paste0("row4","-" , names(seatingChart$row4[seatingChart$row4 == 0])),
  paste0("row5","-" , names(seatingChart$row5[seatingChart$row5 == 0])),
  paste0("row6","-" , names(seatingChart$row6[seatingChart$row6 == 0])),
  paste0("row7","-" , names(seatingChart$row7[seatingChart$row7 == 0]))
) -> availableSeats
...
```{r ans33}
selectedSeat <- "row5-5"
update_seatingChart <- function(seatingChart, selectedSeat) { if(any(selectedSeat %in% list_availableSeats(seatingChart ))){
  pick <- str_extract(selectedSeat ,"[0-9]-[0-9]")
  unlist(str_split(pick , "-")) -> picknew
  str_replace(seatingChart,seatingChart[picknew[[1]]][picknew[[2]] == names(seatingChart[picknew[[1]]])],-1L)
} else {
...
assign_seats <- function(people, seatingChart) {
  ...
  sample(availableSeats,length(people)) -> assign_seat
  names(assign_seat) <- people
  print(assign_seat)
}
