...
garbageRoutes$route <- factor(str_extract(garbageRoutes$linename,"[:alnum:]+路線"))
class(garbageRoutes$route)
levels(garbageRoutes$route)
newLevels <- names(sort(table(garbageRoutes$route)))
garbageRoutes$route <- factor(garbageRoutes$route,levels = newLevels)
garbageRoutes$time <- str_extract(garbageRoutes$linename,
            "(?<=線)[:graph:]+ ")
