...
str_detect(data228$個人名稱,"(吳金練|吳斐如|李瑞峰|李瑞漠|阮朝日|林介|邱金山|施江南|涂光明|張宗仁|許錫謙|陳忻|陳能通|陳澄波|曾鳳鳴|湯德章|黃何純|黃媽典|葉秋木|廖進井|潘木枝|盧鈉欽|蘇憲章)") -> pick_eachVictim
sort(as.integer(table(data228$檔號[pick_eachVictim])),decreasing = T) -> documentCount_eachVictim
...
levels(courseStructure$應修系級) -> levelgrade
levelgrade[[2]]
map(levelgrade,~str_extract(.x,"[:graph:]+系[0-9]"))
str_extract(levelgrade,"[:graph:]+系[0-9]") -> 
