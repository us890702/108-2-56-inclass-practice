...
str_detect(semiGodsSemiDevils$data[[1]][[1]] , "P2") -> pickP2
semiGodsSemiDevils$data[[1]][[2]][pickP2] -> context_picked
...
```{r ans23}
str(context_picked_split)
str_extract_all(context_picked_split[[1]],"姓?段(譽|兄|兄弟|大哥|相公|君|的小子)(?!弟)") -> mention_duan
mention_duan
```
